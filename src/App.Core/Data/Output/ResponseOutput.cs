...
namespace App.Core.Data.Output
{
    ...
    public class ResponseOutput<T> : IResponseOutput<T>
    {
        ...
        /// <param name="data">数据</param>
        /// <returns></returns>
        public ResponseOutput<T> NotOk(ErrorCode errorCode, string msg = null, T data = default(T))
        {
            Success = false;
            Msg = msg ?? errorCode.GetEnumDesc();
            Code = (int)errorCode;
            Data = data;
            return this;
        }
    ...
    public static partial class ResponseOutput
    {
        ...
        /// <param name="data">数据</param>
        /// <returns></returns>
        public static IResponseOutput NotOk<T>(ErrorCode errorCode, string msg = null, T data = default(T))
        {
            return new ResponseOutput<T>().NotOk(errorCode, msg, data);
        }
        ...
        /// <param name="msg">消息</param>
        /// <returns></returns>
        public static IResponseOutput NotOk(ErrorCode errorCode, string msg = null)
        {
            return new ResponseOutput<string>().NotOk(errorCode, msg);
        }
