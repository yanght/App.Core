...
namespace App.Core.Aop.Filter
{
    ...
    public class AppAuthorizeAttribute : Attribute, IAsyncAuthorizationFilter
    {
        ...
        public AppAuthorizeAttribute(string permission, string module)
        {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            if (currentUser.IsInGroup(AppConsts.Group.Admin))
            {
                return;
            }
            ...
            if (!authorizationResult.Succeeded)
            {
                ...
                //throw new AppException("权限不够，请联系超级管理员获得权限", ErrorCode.AuthenticationFailed, StatusCodes.Status401Unauthorized);
