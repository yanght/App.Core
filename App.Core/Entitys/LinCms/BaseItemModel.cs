...
namespace App.Core.Entitys.LinCms {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "base_item")]
	public partial class BaseItemModel {
		...
		[JsonProperty, Column(Name = "base_type_id")]
		...
		[JsonProperty, Column(Name = "item_code", DbType = "varchar(50)")]
		public string ItemCode { get; set; } = string.Empty;

		[JsonProperty, Column(Name = "item_name", DbType = "varchar(50)")]
