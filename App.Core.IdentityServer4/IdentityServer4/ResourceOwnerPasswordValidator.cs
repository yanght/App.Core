...
namespace App.Core.IdentityServer4.IdentityServer4
{
    ...
    public class ResourceOwnerPasswordValidator : IResourceOwnerPasswordValidator
    {
        ...
        public ResourceOwnerPasswordValidator(IUserIdentityService userIdentityService, IUserRepository userRepository)
        {
        ...
        {
            UserEntity user = await _userRepository.Select.Where(r => r.Username == context.UserName || r.Email == context.UserName).ToOneAsync();
